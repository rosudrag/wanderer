...
import classes from './SolarSystemNodeDotlan.module.scss';
...
/**
 * Dotlan-style node: a straight pill box translating Dotlan's system-box semantics
 * (dominant system name, security/class-derived accent) onto wanderer's dark canvas,
 * while keeping every operational affordance (locks, hubs, kills, statics, effects,
 * local counter, four connection handles) that the default node exposes.
 */
export const SolarSystemNodeDotlan = memo((props: NodeProps<MapSolarSystemType>) => {
  ...
  return (
    <>
      ...
      >
        {nodeVars.visible && (
          <>
            <div className={clsx(classes.SecurityAccent, nodeVars.classTitleColor)} />

            <div className={classes.DotlanBody}>
              <div className={clsx(classes.AccentTint, nodeVars.classTitleColor)} />

              <div className={classes.NameRow}>
                <div className={clsx(classes.SystemName, '[text-shadow:_0_1px_0_rgb(0_0_0_/_40%)]')}>
                  {nodeVars.systemName}
                </div>
              ...
              <div className={classes.SecondaryRow}>
                <div className={clsx(classes.ClassBadge, nodeVars.classTitleColor)}>{nodeVars.classTitle ?? '-'}</div>
                ...
                <div className={clsx(classes.SecondaryText, 'flex-grow')}>
                  {nodeVars.customName || (!nodeVars.isWormhole ? nodeVars.regionName : null)}
                </div>
                ...
                <div className={classes.SecondaryRight}>
                  <div className={classes.StatusIcons}>
                    ...
                    {nodeVars.hubs.includes(nodeVars.solarSystemId) && (
                      <i className={clsx(PrimeIcons.MAP_MARKER, classes.HubIcon)} />
                    )}
...
SolarSystemNodeDotlan.displayName = 'SolarSystemNodeDotlan';
